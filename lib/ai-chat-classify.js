...
const PRODUCT_RULES = [
    ...
    },
    {
        ...
        context: [/\borc k2\b/, /\brobot orc k2\b/, /\bk2\b/],
    },
    {
        category: 'orc_k3',
        label: 'ORC K3',
        ...
        context: [/\borc k3\b/, /\brobot orc k3\b/, /\bk3\b/],
    },
    {
        category: 'rover',
        label: 'Robot Rover',
    ...
    },
    {
        ...
        label: 'Yolo UNO',
        score: 82,
        strong: [/\byolo uno\b/, /\byolouno\b/, /\byolo\b/],
        context: [/\byolo uno\b/, /\byolouno\b/, /\byolo\b/],
    },
    {
        category: 'yolobit',
        label: 'Yolo:Bit',
    ...
    {
        category: 'green_house',
        label: 'Nha kinh thong minh',
        score: 80,
        strong: [
            /\bgreen house\b/,
            /\bgreenhouse\b/,
            /\bnha kinh\b/,
            /\bnha kinh thong minh\b/,
        ],
        context: [/\bnha kinh\b/, /\bgreen house\b/],
    },
    {
        category: 'smart_home',
        ...
        context: [/\bnha thong minh\b/, /\bsmart home\b/],
    },
    {
        category: 'thanh_pho_thong_minh',
        label: 'Thanh pho thong minh',
        score: 80,
        strong: [
            /\bthanh pho thong minh\b/,
            /\bsmart city\b/,
            /\btram giam sat\b/,
        ],
        context: [/\bthanh pho thong minh\b/, /\btram giam sat\b/],
    },
    {
        category: 'thung_rac',
        label: 'Thung rac thong minh',
        score: 78,
        strong: [
            /\bthung rac\b/,
            /\bthung rac thong minh\b/,
            /\btrash bin\b/,
        ],
        context: [/\bthung rac\b/],
    },
    {
        category: 'ohstem_app',
        label: 'OhStem App',
...
const TAG_RULES = [
    ...
    ['orc_junior', [/\borc junior\b/, /\brover orc junior\b/, /\bjunior\b/]],
    [
        'motion_kit',
    ...
    ['yolo_uno', [/\byolo uno\b/, /\byolouno\b/, /\byolo\b/]],
    ['green_house', [/\bgreen house\b/, /\bgreenhouse\b/, /\bnha kinh\b/]],
    ['smart_home', [/\bnha thong minh\b/, /\bsmart home\b/]],
    ['thanh_pho', [/\bthanh pho thong minh\b/, /\bsmart city\b/, /\btram giam sat\b/]],
    ['thung_rac', [/\bthung rac\b/, /\btrash bin\b/]],
    ...
    // Cam bien cu the
    ['bmp280', [/\bbmp280\b/, /\bap suat\b/]],
    ['sht30', [/\bsht30\b/, /\bsht3x\b/]],
    ['guva_s12sd', [/\bguva\b/, /\bs12sd\b/, /\btia uv\b/, /\buv\b/]],
    ['acd1100', [/\bacd1100\b/, /\bco2\b/, /\bcarbon dioxide\b/]],
    ['dc01', [/\bdc01\b/, /\bbui min\b/, /\bpm2 5\b/, /\bpm25\b/]],
    ['toc_do_gio', [/\btoc do gio\b/, /\bgio\b/, /\banemometer\b/]],
    ['nang_luong_mat_troi', [/\bnang luong mat troi\b/, /\bsolar\b/, /\bpin mat troi\b/]],
]
...
function detectProductCategory(combined = '') {
    ...
    PRODUCT_RULES.forEach((rule) => {
        ...
        if (rule.weak && rule.weak.length > 0 && hasMatch(combined, rule.weak)) {
            if (!rule.support || hasMatch(combined, rule.support)) {
                score += Math.max(58, Math.round(rule.score * 0.78))
            } else {
                // Standalone weak match still gets a decent score
                score += Math.max(42, Math.round(rule.score * 0.52))
            }
        }
