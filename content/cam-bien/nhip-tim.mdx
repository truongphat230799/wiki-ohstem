---
title: "26. Cảm biến nhịp tim và oxy trong máu MAX30102:"
---

# 26. Cảm biến nhịp tim và oxy trong máu MAX30102:
![nhip tim](/images/module/cam-bien/images/nhip_tim.webp)
...
| <img src="/images/module/cam-bien/images/nhip_tim.webp" alt="nhip tim" width="180" /> | Cảm biến nhịp tim | Mua tại các cửa hàng linh kiện điện tử |
...
![nhip tim 1](/images/module/cam-bien/images/nhip_tim_1.png)
...
Để làm việc với cảm biến nhịp tim MAX30102, chúng ta phải cần thêm thư viện mở rộng **MAX30102**, bạn hãy copy đường dẫn sau: [https://github.com/AITT-VN/yolobit_extension_max30102](https://github.com/AITT-VN/yolobit_extension_max30102) và dán vào mục mở rộng để tải thư viện mở rộng.

    Xem hướng dẫn tải thư viện `tại đây ](https://docs.ohstem.vn/en/latest/module/cai-dat-thu-vien.html).
![nhip tim 2](/images/module/cam-bien/images/nhip_tim_2.png)
...
![nhip tim 3](/images/module/cam-bien/images/nhip_tim_3.png)
...
> **Ghi chú:** **Giải thích chương trình:** Sau khi chạy chương trình, thông tin vị nhịp tim sẽ được hiển thị trên cửa số Serial