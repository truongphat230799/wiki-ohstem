---
title: "12. Cảm biến màu sắc"
---

# 12. Cảm biến màu sắc
![13.1](/images/module/cam-bien/images/13.1.png)
...
| <img src="/images/module/cam-bien/images/13.1.png" alt="13.1" width="180" /> | Cảm biến màu sắc (kèm dây Grove) | [Mua sản phẩm ](https://shop.ohstem.vn/san-pham/cam-bien-mau-sac/) |
    
    
- **Bước 2**: Cắm Yolo:Bit vào mạch mở rộng
- **Bước 3**: Sử dụng dây Grove cắm vào cảm biến
- **Bước 4**: Kết nối cảm biến với **cổng I2C trên mạch mở rộng**.
![13.2](/images/module/cam-bien/images/13.2.png)


    Bạn có thể kết nối vào 1 trong 2 chân I2C
    
## **4. Hướng dẫn lập trình với OhStem App:**
- **Bước 1**: Để làm việc với cảm biến, bạn cần tải thư viện **Cảm biến màu sắc**, xem hướng dẫn tải thư viện [tại đây ](https://docs.ohstem.vn/en/latest/module/thu-vien-yolobit.html).
![13.3](/images/module/cam-bien/images/13.3.png)

    |
    
    Sau khi tải thư viện, trong danh mục khối lệnh sẽ xuất hiện các khối lệnh tương ứng:
![13.4](/images/module/cam-bien/images/13.4.png)

    |
    
- **Bước 2**: Gửi chương trình sau lên Yolo:Bit:
![13.5](/images/module/cam-bien/images/13.5.png)
...
![13.6](/images/module/cam-bien/images/13.6.png)
...
![13.7](/images/module/cam-bien/images/13.7.png)
