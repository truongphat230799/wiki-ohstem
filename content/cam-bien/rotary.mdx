---
title: "22. Cảm biến góc xoay - Rotary Encoder"
---

# 22. Cảm biến góc xoay - Rotary Encoder
![23.1](/images/module/cam-bien/images/23.1.png)
...
| <img src="/images/module/cam-bien/images/23.1.png" alt="23.1" width="180" /> | Module Rotary Encoder (kèm dây Grove) | [Mua sản phẩm ](https://shop.ohstem.vn/san-pham/rotary-encoder/) |
| <img src="/images/module/cam-bien/images/quat_mini.png" alt="quat mini" width="180" /> | Quạt mini (kèm dây Grove) | [Mua sản phẩm ](https://shop.ohstem.vn/san-pham/dong-co-quat-mini/) |
    
    
- **Bước 2**: Cắm Yolo:Bit vào mạch mở rộng
- **Bước 3**: Sử dụng dây Grove cắm vào cảm biến
- **Bước 4**: Kết nối Rotary Encoder và quạt mini với mạch mở rộng như sau:
![23.2](/images/module/cam-bien/images/23.2.png)
...
- **Bước 1:** Tải thư viện **Rotary Encoder**, bằng cách dán đường link sau vào phần tìm kiếm thư viện: [https://github.com/AITT-VN/yolobit_rotary_encoder.git ](https://github.com/AITT-VN/yolobit_rotary_encoder.git)

    Xem hướng dẫn tải thư viện [tại đây ](https://docs.ohstem.vn/en/latest/module/thu-vien-yolobit.html)
![rotary](/images/module/cam-bien/images/rotary.png)

    |
    
    Sau khi tải thư viện, trong danh mục khối lệnh sẽ xuất hiện các khối lệnh tương ứng:
![lenh rotary](/images/module/cam-bien/images/lenh_rotary.png)

    |
    
    
- **Bước 2:** **Để làm việc với quạt mini** bạn hãy tải thư viện **AIOT KIT** ,  xem hướng dẫn [tại đây ](https://docs.ohstem.vn/en/latest/module/dong-co/quat-mini.html)
...
![23.3](/images/module/cam-bien/images/23.3.png)

    |
    
    + Tiếp theo, gửi chương trình sau xuống Yolo:Bit:
![23.4](/images/module/cam-bien/images/23.4.png)


        Câu lệnh **bật quạt chân P14 với tốc độ (0 -100)** nằm trong danh mục khối lệnh **AIOT KIT**
    
    
> **Ghi chú:** **Giải thích chương trình**: Chúng ta sẽ lập trình các mức độ của quạt khi xoay Encoder:
...
## 5. **Chương trình mẫu:**
- Xem chương trình: [Tại đây ](https://app.ohstem.vn/#!/share/yolobit/2H4YlGJ8lAd8DUExjFdCg2XfiqC)
![23.5](/images/module/cam-bien/images/23.5.png)
...
> **Ghi chú:** **Giải thích chương trình:** Sau khi chạy chương trình, giá trị của độ sáng sẽ được chuyển từ giá trị analog 0- 4095 thành 0 - 100%. Khi núm xoay của cảm biến được vặn, độ sáng sẽ được thay đổi.