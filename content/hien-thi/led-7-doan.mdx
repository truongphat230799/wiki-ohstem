---
title: "1. Màn hình 4 số LED 7 đoạn"
---

# 1. Màn hình 4 số LED 7 đoạn
![1.1](/images/module/hien-thi/images/1.1.png)
...
| <img src="/images/module/hien-thi/images/1.1.png" alt="1.1" width="180" /> | Màn hình LED 7 đoạn (kèm dây Grove) | [Mua sản phẩm ](https://shop.ohstem.vn/san-pham/led-7-doan/) |
    
    
- **Bước 2**: Cắm Yolo:Bit vào mạch mở rộng
- **Bước 3**: Sử dụng dây Grove cắm vào màn hình LED
- **Bước 4**: Kết nối thiết bị vào **P10/ P13 trên mạch mở rộng**
![1.2](/images/module/hien-thi/images/1.2.png)


    Trên mạch mở rộng các bạn có thể sử dụng các khe cắm có 2 chân tín hiệu để kết nối với LED 7 đoạn
    
## **4. Hướng dẫn lập trình với OhStem App**
- **Bước 1**: Tải thư viện **LED 7 đoạn**, bằng cách dán đường link sau [https://github.com/AITT-VN/yolobit_extension_led7segment.git ](https://github.com/AITT-VN/yolobit_extension_led7segment.git) vào phần tìm kiếm thư viện.

    Xem hướng dẫn tải thư viện [tại đây ](https://docs.ohstem.vn/en/latest/module/thu-vien-yolobit.html)
![1.3](/images/module/hien-thi/images/1.3.png)


    Sau khi tải thư viện thành công, trong danh mục khối lệnh sẽ xuất hiện các khối lệnh tương ứng:
![1.4](/images/module/hien-thi/images/1.4.png)


    Để làm việc với module LED 7 đoạn bạn cần sử dụng câu lệnh sau để khai báo chân được sử dụng trong chương trình:
![1.5](/images/module/hien-thi/images/1.5.png)


- **Bước 2:** Gửi chương trình sau vào Yolo:Bit:
![1.6](/images/module/hien-thi/images/1.6.png)
...
> **Ghi chú:** **Giải thích chương trình:** Sau khi chạy chương trình, các thông tin sẽ được hiển thị lên màn hình LED