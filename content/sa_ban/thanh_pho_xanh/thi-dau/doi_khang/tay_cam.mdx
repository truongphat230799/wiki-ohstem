---
title: "7. 1. Lập trình tay cầm điều khiển"
---

# 7. 1. Lập trình tay cầm điều khiển
![7](/images/sa_ban/thanh_pho_xanh/thi-dau/doi_khang/images/7.png)
...
GamePad shield được dùng với Yolo:Bit. Bạn có thể tham khảo hướng dẫn lập trình cho Yolo:Bit [ở đây ](https://docs.ohstem.vn/en/latest/yolobit_v2/lam-quen.html) nếu chưa từng làm việc với Yolo:Bit trước đó.


## **1. Cài đặt thư viện mở rộng cho GamePad**
    1. Chọn thiết bị lập trình là Yolo:Bit trong OhStem App, tại địa chỉ [https://app.ohstem.vn/](https://app.ohstem.vn/) hoặc ứng dụng OhStem App trên mobile (Tải trên Google Play / App Store với tên tìm kiếm là  “OhStem App”)
![7.1](/images/sa_ban/thanh_pho_xanh/thi-dau/doi_khang/images/7.1.png)


    2. Nhấn vào mục **Mở Rộng** ở danh sách bên trái:
![7.2](/images/sa_ban/thanh_pho_xanh/thi-dau/doi_khang/images/7.2.png)


    3. Chọn GamePad trong danh sách các mục mở rộng có sẵn (hoặc nhập tên GamePad vào ô tìm kiếm nếu bạn không thấy):
![7.3](/images/sa_ban/thanh_pho_xanh/thi-dau/doi_khang/images/7.3.jpg)


    Chọn tải thư viện:
![7.4](/images/sa_ban/thanh_pho_xanh/thi-dau/doi_khang/images/7.4.png)
...
![7.5](/images/sa_ban/thanh_pho_xanh/thi-dau/doi_khang/images/7.5.png)


## **2. Giới thiệu khối lệnh**
    Bên trong danh mục GamePad, bạn sẽ thấy có 3 khối lệnh:
![7.6](/images/sa_ban/thanh_pho_xanh/thi-dau/doi_khang/images/7.6.png)
...
![7.7](/images/sa_ban/thanh_pho_xanh/thi-dau/doi_khang/images/7.7.png)
...
**Đọc Joystick**
    ...
    Bạn có thể chọn vào icon hình tam giác ngược trong khối lệnh để hiển thị các lựa chọn khác:
![7.8](/images/sa_ban/thanh_pho_xanh/thi-dau/doi_khang/images/7.8.png)


    - X: Trả về giá trị Analog cho **trục X (trục ngang)** của Joystick theo thang giá trị từ -100 đến 100
![7.9](/images/sa_ban/thanh_pho_xanh/thi-dau/doi_khang/images/7.9.jpg)


    - Y: Trả về giá trị Analog cho trục Y (trục dọc) của Joystick theo thang giá trị từ -100 đến 100.
![7.10](/images/sa_ban/thanh_pho_xanh/thi-dau/doi_khang/images/7.10.jpg)


    - Góc quay: Trả về giá trị góc xoay của cần gạt Joystick theo thang đo từ 0 đến 359 độ:
![7.11](/images/sa_ban/thanh_pho_xanh/thi-dau/doi_khang/images/7.11.jpg)


    - Khoảng cách kéo: Mức độ kéo Joystick ra ngoài so với tâm của cần gạt (từ 0 – 100%)
![7.12](/images/sa_ban/thanh_pho_xanh/thi-dau/doi_khang/images/7.12.jpg)


**Nút ____ được nhấn**

    Bạn có thể chọn vào icon hình tam giác ngược trong khối lệnh để hiển thị các lựa chọn khác:
![7.13](/images/sa_ban/thanh_pho_xanh/thi-dau/doi_khang/images/7.13.jpg)
...
* :download:`Tại đây [https://app.ohstem.vn/#!/share/yolobit/22dRxWKg7y1vRI2y73DEKXygbyd](https://app.ohstem.vn/#!/share/yolobit/22dRxWKg7y1vRI2y73DEKXygbyd)`


## **Hướng dẫn lập trình**
1. Đầu tiên, chúng ta xóa màn hình trước đó:
![7.14](/images/sa_ban/thanh_pho_xanh/thi-dau/doi_khang/images/7.14.jpg)


2. Nếu nút A được nhấn, màn hình Yolo:Bit sẽ hiển thị chữ A:
![7.15](/images/sa_ban/thanh_pho_xanh/thi-dau/doi_khang/images/7.15.jpg)


3. Ta thực hiện tương tự với các nút còn lại:
![7.16](/images/sa_ban/thanh_pho_xanh/thi-dau/doi_khang/images/7.16.png)


4. Đặt điều kiện: Nếu Joystick xoay về hướng bên phải:
![7.17](/images/sa_ban/thanh_pho_xanh/thi-dau/doi_khang/images/7.17.jpg)


5. Lúc này, Yolo:Bit sẽ hiển thị hình ảnh mũi tên chỉ sang phải:
![7.18](/images/sa_ban/thanh_pho_xanh/thi-dau/doi_khang/images/7.18.jpg)


6. Nhấn vào icon hình bánh răng và tạo thêm 3 nhánh điều kiện **Nếu không nếu** như hình:
![7.19](/images/sa_ban/thanh_pho_xanh/thi-dau/doi_khang/images/7.19.jpg)


**Giải thích thêm:**

Điều kiện “nếu không nếu” là một điều kiện gộp giữa “nếu không” và “nếu”:
![7.20](/images/sa_ban/thanh_pho_xanh/thi-dau/doi_khang/images/7.20.jpg)


7. Tương tự, ta cho Yolo:Bit hiển thị mũi tên tương ứng với từng hướng xoay của Joystick trong thuật toán:
![7.21](/images/sa_ban/thanh_pho_xanh/thi-dau/doi_khang/images/7.21.png)


8. Hiển thị thông tin góc xoay ra cửa sổ thông tin và cập nhật liên tục sau mỗi 200ms (1 giây = 1000ms):
![7.22](/images/sa_ban/thanh_pho_xanh/thi-dau/doi_khang/images/7.22.jpg)


> **Ghi chú:** Để hiển thị cửa sổ thông tin, bạn hãy nhấn vào nút chức năng nâng cao (biểu tưởng bánh răng), chọn Hiển thị cửa sổ thông tin để mở cửa sổ hiển thị thông tin như sau:
![7.23](/images/sa_ban/thanh_pho_xanh/thi-dau/doi_khang/images/7.23.png)
:align: center