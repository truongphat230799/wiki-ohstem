...
- **Sơ đồ mạch điện**
![bai 3.1](/images/yolobit_v2/physbit/images/bai_3.1.png)
...
![bai 3.2](/images/yolobit_v2/physbit/images/bai_3.2.png)
...
![bai 3.3](/images/yolobit_v2/physbit/images/bai_3.3.png)
...
- Nút nhấn đa hướng
![3.2](/images/yolobit_v2/physbit/images/3.2.png)

    |
- Công tắc lật
![3.3](/images/yolobit_v2/physbit/images/3.3.png)

    |
- Công tắc xoay
![3.4](/images/yolobit_v2/physbit/images/3.4.png)

    |
- Công tắc chuyển mạch
![3.5](/images/yolobit_v2/physbit/images/3.5.png)

    |
    
## Chương trình mẫu
- Nút nhấn giữ: [Tại đây ](https://app.ohstem.vn/#!/share/yolobit/2Bvdajf3k2cda4pfLbd8fP2mgDQ)
![bai 3.4](/images/yolobit_v2/physbit/images/bai_3.4.png)
