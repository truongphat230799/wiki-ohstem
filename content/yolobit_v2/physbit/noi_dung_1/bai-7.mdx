...
![7.1](/images/yolobit_v2/physbit/noi_dung_1/images/7.1.png)
...
![7.2](/images/yolobit_v2/physbit/noi_dung_1/images/7.2.png)
...
- **Sơ đồ mạch điện**
![7.3](/images/yolobit_v2/physbit/noi_dung_1/images/7.3.png)
...
![7.4](/images/yolobit_v2/physbit/noi_dung_1/images/7.4.png)

    |
    - Ngược lại, khi nối TRIGGER với GND, MOSFET mở, không có dòng điện chạy qua nên buzzer không hoạt động.
![7.5](/images/yolobit_v2/physbit/noi_dung_1/images/7.5.png)

    |
    
## Kết nối mạch điện
Hãy lắp mạch điện như hình minh họa bên dưới:
![7.6](/images/yolobit_v2/physbit/noi_dung_1/images/7.6.png)
