---
title: "6. Bài 4: Đèn LED nhiều màu RGB"
---
...
![4.1](/images/yolobit_v2/physbit/images/4.1.png)
...
- **Sơ đồ mạch điện**
![bai 4.1](/images/yolobit_v2/physbit/images/bai_4.1.png)
...
![bai 4.2](/images/yolobit_v2/physbit/images/bai_4.2.png)
...
![bai 4.3](/images/yolobit_v2/physbit/images/bai_4.3.png)

    |
    
## Kết quả
Kết quả của chương trình như sau:
![bai 4.4](/images/yolobit_v2/physbit/images/bai_4.4.png)
...
## Bài tập mở rộng
**Hãy thử làm**
![4.4](/images/yolobit_v2/physbit/images/4.4.png)
...
## Chương trình mẫu
- Đèn LED nhiều màu RGB: [Tại đây ](https://app.ohstem.vn/#!/share/yolobit/2Bvf46BGe5xCwR304j8G7L3mR8d)
![bai 4.5](/images/yolobit_v2/physbit/images/bai_4.5.png)
