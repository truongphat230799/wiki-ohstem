---
title: "8. Bài 6: Cảm biến ánh sáng"
---
...
![6.1](/images/yolobit_v2/physbit/images/6.1.png)
...
- **Sơ đồ mạch điện**
![bai 6.1](/images/yolobit_v2/physbit/images/bai_6.1.png)
...
![bai 6.2](/images/yolobit_v2/physbit/images/bai_6.2.png)
...
![bai 7.3](/images/yolobit_v2/physbit/images/bai_7.3.png)



    2. Khi tạo biến thành công, trong mục Biến sẽ xuất hiện những khối lệnh liên quan để làm việc với biến.
![bai 7.4](/images/yolobit_v2/physbit/images/bai_7.4.png)


- Chương trình được thực hiện như sau:
![bai 6.3](/images/yolobit_v2/physbit/images/bai_6.3.png)

    |
    
## Kết quả
Kết quả của chương trình như sau:
![bai 6.4](/images/yolobit_v2/physbit/images/bai_6.4.png)
...
## Chương trình mẫu
- Cảm biến ánh sáng: [Tại đây ](https://app.ohstem.vn/#!/share/yolobit/2Bvj7i0nZRgJpXcZY4cYA5kZ4en)
![bai 6.5](/images/yolobit_v2/physbit/images/bai_6.5.png)
