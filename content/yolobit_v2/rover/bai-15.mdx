...
![bai 15.1](/images/yolobit_v2/rover/images/bai_15.1.png)
...
![bai 15.2](/images/yolobit_v2/rover/images/bai_15.2.png)


    2. Chọn mục cài đặt >> Đổi tên thiết bị
![bai 15.3](/images/yolobit_v2/rover/images/bai_15.3.png)


    3. Tiến hành đổi tên
![bai 15.4](/images/yolobit_v2/rover/images/bai_15.4.png)


## Viết chương trình
1. Viết thuật toán cho Yolo:Bit riêng lẻ
![bai 15.5](/images/yolobit_v2/rover/images/bai_15.5.png)


2. Tạo các sự kiện khi kết nối và ngắt kết nối Bluetooth
![bai 15.6](/images/yolobit_v2/rover/images/bai_15.6.png)


3. Kết nối Bluetooth tự động và sáng đèn màu đỏ
![bai 15.7](/images/yolobit_v2/rover/images/bai_15.7.png)


4. Tạo nhóm điều kiện gộp tương ứng với trạng thái nghiêng của Yolo:Bit
![bai 15.8](/images/yolobit_v2/rover/images/bai_15.8.png)


5. Đặt lệnh gửi đi tương ứng trong thuật toán
![bai 15.9](/images/yolobit_v2/rover/images/bai_15.9.png)


6. Tạm dừng 100milli giây ở cuối chương trình
![bai 15.10](/images/yolobit_v2/rover/images/bai_15.10.png)


7. Chương trình đầy đủ cho Yolo:Bit riêng lẻ
![bai 15.11](/images/yolobit_v2/rover/images/bai_15.11.png)
...
![bai 15.12](/images/yolobit_v2/rover/images/bai_15.12.png)


9. Viết thuật toán cho Yolo:Bit trên Rover
![bai 15.13](/images/yolobit_v2/rover/images/bai_15.13.png)


10. Viết các lệnh phù hợp với tín hiệu nhận được từ Yolo:Bit khác
![bai 15.14](/images/yolobit_v2/rover/images/bai_15.14.png)


## Chương trình mẫu
- Giao tiếp cùng đồng đội: [Tại đây ](https://app.ohstem.vn/#!/share/yolobit/2BeZHkGMwf5gCeaOPHSj5n60Inj)
![bai 15.15](/images/yolobit_v2/rover/images/bai_15.15.png)
