...
![bai 18.1](/images/yolobit_v2/rover/images/bai_18.1.png)
...
![bai 18.2](/images/yolobit_v2/rover/images/bai_18.2.png)

    |
    - Internet công nghiệp:
![bai 18.3](/images/yolobit_v2/rover/images/bai_18.3.png)

    |
    - Hỗ trợ nông nghiệp và nhiều ứng dụng khác
![bai 18.3.1](/images/yolobit_v2/rover/images/bai_18.3.1.png)

    |
    
- **Kết nối WiFi trong IoT:** Có vai trò cực kỳ quan trọng trong IoT, là công nghệ chính để truyền dữ liệu trong hệ thống IoT
![bai 18.5](/images/yolobit_v2/rover/images/bai_18.5.png)
...
![bai 18.6](/images/yolobit_v2/rover/images/bai_18.6.png)
...
![bai 18.10](/images/yolobit_v2/rover/images/bai_18.10.png)
...
![bai 18.14](/images/yolobit_v2/rover/images/bai_18.14.png)

    |
2. Chọn **Tạo mới**
![bai 18.15](/images/yolobit_v2/rover/images/bai_18.15.png)

    |
3. Kéo thả và sắp xếp các công cụ điều khiển (widget) theo ý muốn
![bai 18.16](/images/yolobit_v2/rover/images/bai_18.16.png)

    |
    
**Giao diện cấu hình bảng điều khiển IoT**
![bai 18.17](/images/yolobit_v2/rover/images/bai_18.17.png)
...
![bai 18.18](/images/yolobit_v2/rover/images/bai_18.18.png)

    |
    2. Nhấn vào Color Picker và cấu hình kênh là V1.
![bai 18.19](/images/yolobit_v2/rover/images/bai_18.19.png)

    |
    3. Nhấn nút Play để chuyển về chế độ điều khiển
![bai 18.20](/images/yolobit_v2/rover/images/bai_18.20.png)
...
![bai 18.21](/images/yolobit_v2/rover/images/bai_18.21.png)
...
![bai 18.22](/images/yolobit_v2/rover/images/bai_18.22.png)
...
![bai 18.23](/images/yolobit_v2/rover/images/bai_18.23.png)
...
![bai 18.24](/images/yolobit_v2/rover/images/bai_18.24.png)
...
![bai 18.25](/images/yolobit_v2/rover/images/bai_18.25.png)
...
![bai 18.26](/images/yolobit_v2/rover/images/bai_18.26.png)

    |
    2. Đặt tên, cấu hình kênh V2 và chọn cách hiển thị
![bai 18.27](/images/yolobit_v2/rover/images/bai_18.27.png)

    |
    3. Thực hiện tương tự với ánh sáng (V3)
![bai 18.28](/images/yolobit_v2/rover/images/bai_18.28.png)
...
![bai 18.29](/images/yolobit_v2/rover/images/bai_18.29.png)

    |
    2. Tải thư viện **SỰ KIỆN**
![bai 18.30](/images/yolobit_v2/rover/images/bai_18.30.png)

    |
    3. Tải hoàn tất:
![bai 18.31](/images/yolobit_v2/rover/images/bai_18.31.png)
...
![bai 18.32](/images/yolobit_v2/rover/images/bai_18.32.png)

    |
    2. Chương trình hoàn chỉnh để gửi thông tin lên bảng điều khiển.
![bai 18.33](/images/yolobit_v2/rover/images/bai_18.33.png)
...
**Cấu hình bảng điều khiển IoT**
    ...
    1. Kéo Widget thông tin ra ngoài
![bai 18.34](/images/yolobit_v2/rover/images/bai_18.34.png)

    |
    2. Đặt tên, cấu hình kênh V4.
![bai 18.35](/images/yolobit_v2/rover/images/bai_18.35.png)

    |
    3. Thực hiện tương tự cho đèn phải (V5)
![bai 18.36](/images/yolobit_v2/rover/images/bai_18.36.png)
...
![bai 18.37](/images/yolobit_v2/rover/images/bai_18.37.png)

    |
    2. So sánh thông tin nhận được với giá trị kiểu chuỗi “1” và “0” bằng khối lệnh trong mục **Chữ viết**
![bai 18.42.1](/images/yolobit_v2/rover/images/bai_18.42.1.png)


    Chương trình hoàn chỉnh như sau:
![bai 18.38.1](/images/yolobit_v2/rover/images/bai_18.38.1.png)
...
![bai 18.39](/images/yolobit_v2/rover/images/bai_18.39.png)

    |
    2. Chọn kênh thông tin V6
![bai 18.40](/images/yolobit_v2/rover/images/bai_18.40.png)
...
![bai 18.41](/images/yolobit_v2/rover/images/bai_18.41.png)

    |
    2. So sánh thông tin nhận được và điều khiển robot tương ứng
![bai 18.42](/images/yolobit_v2/rover/images/bai_18.42.png)
...
![bai 18.1.1](/images/yolobit_v2/rover/images/bai_18.1.1.png)

    |
- Định kỳ cập nhật thông tin lên Server IoT: [Tại đây ](https://app.ohstem.vn/#!/share/yolobit/2BpkqRmUtvGOpKkcMlfMTGBhREV)
![bai 18.1.2](/images/yolobit_v2/rover/images/bai_18.1.2.png)
...
![bai 18.1.3](/images/yolobit_v2/rover/images/bai_18.1.3.png)

    |
- Điều khiển di chuyển qua Internet: [Tại đây ](https://app.ohstem.vn/#!/share/yolobit/2BpoDOSmODzxELqBDkCjHvLwirU)
![bai 18.1.4](/images/yolobit_v2/rover/images/bai_18.1.4.png)
