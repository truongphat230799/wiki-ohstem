...
![bai 17](/images/yolobit_v2/rover/images/bai_17.png)
...
![bai 17.1](/images/yolobit_v2/rover/images/bai_17.1.png)

    |
    - Nhận dạng tội phạm tại nơi công cộng:
![bai 17.2](/images/yolobit_v2/rover/images/bai_17.2.png)

    |
    - Điểm danh học sinh đến lớp và nhiều ứng dụng khác
![bai 17.3](/images/yolobit_v2/rover/images/bai_17.3.png)

    |
    
## Giới thiệu khối lệnh
- Khối lệnh Bật Camera trên thiết bị (có thể chọn camera trước / selfi).
![bai 17.3.1](/images/yolobit_v2/rover/images/bai_17.3.1.png)
...
![bai 17.3.2](/images/yolobit_v2/rover/images/bai_17.3.2.png)

    |
- Khối lệnh đổi hình nền sang màu trắng để xóa kết quả nhận dạng trước đó.
![bai 17.3.3](/images/yolobit_v2/rover/images/bai_17.3.3.png)
...
![bai 17.4](/images/yolobit_v2/rover/images/bai_17.4.png)
...
![bai 17.5](/images/yolobit_v2/rover/images/bai_17.5.png)

    |
    Giao diện hiện ra có các chức năng như sau:
![bai 17.6](/images/yolobit_v2/rover/images/bai_17.6.png)
...
![bai 17.7](/images/yolobit_v2/rover/images/bai_17.7.png)
...
![bai 17.8](/images/yolobit_v2/rover/images/bai_17.8.png)

    |
    - **Bước 4:** Chọn **HUẤN LUYỆN MÔ HÌNH** và chờ hệ thống huấn luyện
![bai 17.9](/images/yolobit_v2/rover/images/bai_17.9.png)

    |
    - **Bước 5:** Đặt tên và nhấn lưu mô hình
![bai 17.10](/images/yolobit_v2/rover/images/bai_17.10.png)
...
![bai 17.11](/images/yolobit_v2/rover/images/bai_17.11.png)


- **Bước 2**: Thực hiện các tính năng cơ bản để khởi động Camera và hiện hình ảnh từ Camera.
![bai 17.12](/images/yolobit_v2/rover/images/bai_17.12.png)
...
![bai 17.13](/images/yolobit_v2/rover/images/bai_17.13.png)
...
![bai 17.14](/images/yolobit_v2/rover/images/bai_17.14.png)
...
![bai 17.15](/images/yolobit_v2/rover/images/bai_17.15.png)


## Chương trình mẫu
- Điều khiển robot bằng cử chỉ: [Tại đây ](https://app.ohstem.vn/#!/share/yolobit/2BpKqusnQZvl4NCedunFO33IT9h)
![bai 17.16](/images/yolobit_v2/rover/images/bai_17.16.png)
