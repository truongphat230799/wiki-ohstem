...
![bai 1.4](/images/yolobit_v2/rover/images/bai_1.4.png)


- Rover có 2 động cơ bên trái và bên  phải, để Rover di chuyển, chúng ta  cần điều khiển 2 động cơ này
![bai 1.5](/images/yolobit_v2/rover/images/bai_1.5.png)


## Giới thiệu khối lệnh
- Khối lệnh bắt đầu chương trình:
![bai 1.6](/images/yolobit_v2/rover/images/bai_1.6.png)


- Khối lệnh lặp lại số lần:
![bai 1.7](/images/yolobit_v2/rover/images/bai_1.7.png)


- Khối lệnh di chuyển:
![bai 1.8](/images/yolobit_v2/rover/images/bai_1.8.png)
...
![bai 1.9](/images/yolobit_v2/rover/images/bai_1.9.png)
...
![bai 1.10](/images/yolobit_v2/rover/images/bai_1.10.png)

    |
    3. Thêm khối tạm dừng 1 giây (1000ms)
![bai 1.11](/images/yolobit_v2/rover/images/bai_1.11.png)

    |
    4. Làm tương tự để tạo thêm lệnh đi lùi trong 1 giây
![bai 1.12](/images/yolobit_v2/rover/images/bai_1.12.png)

    |
    5. Chạy chương trình
![bai 1.13](/images/yolobit_v2/rover/images/bai_1.13.png)

    |
    6.  Bạn có thể nhấn nút tạm dừng để dừng chương trình lại
![bai 1.14](/images/yolobit_v2/rover/images/bai_1.14.png)
...
![bai 1.15](/images/yolobit_v2/rover/images/bai_1.15.png)

    |
    2. Sử dụng các khối lệnh di chuyển để hoàn thiện chương trình như hình minh họa (để ý các thông số)
![bai 1.16](/images/yolobit_v2/rover/images/bai_1.16.png)
...
![bai 1.17](/images/yolobit_v2/rover/images/bai_1.17.png)


- Robot di chuyển hình vuông: [Tại đây ](https://app.ohstem.vn/#!/share/yolobit/2BeTxamvWwDappzIrPkZx9j7xl3)
![bai 1.18](/images/yolobit_v2/rover/images/bai_1.18.png)
