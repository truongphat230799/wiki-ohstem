...
# Biến
![catologe variable](/images/app/block-api/images/catologe-variable.png)
...
![variable 0](/images/app/block-api/images/variable-0.png)
...
![variable 1](/images/app/block-api/images/variable-1.png)


Sau khi tạo biến xong, trong danh mục BIẾN sẽ xuất hiện một số khối lệnh mới để bạn sử dụng:
![variable 2](/images/app/block-api/images/variable-2.png)


## Các khối lệnh của một biến
Đặt giá trị của biến bằng một giá trị cụ thể nào đó, có thể là số, chữ, ...
![variable 3](/images/app/block-api/images/variable-3.png)


Cộng vào biến trên một giá trị đầu vào.
![variable 4](/images/app/block-api/images/variable-4.png)


Hoàn trả lại kết quả là giá trị của đầu vào.
![variable 5](/images/app/block-api/images/variable-5.png)


## Ví dụ
Đếm số lần nhấn nút
![variable 6](/images/app/block-api/images/variable-6.png)
