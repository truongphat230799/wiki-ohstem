---
title: "servo.rotate(index, change, sleep, degree)"
---

# servo.rotate(index, change, sleep, degree)
![servo 2](/images/app/block-api/api-move/images/servo-2.png)
...
## Ví dụ
![move vd 7](/images/app/block-api/api-move/images/move-vd-7.png)
