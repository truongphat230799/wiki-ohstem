---
title: "5. Lập trình di chuyển các bộ phận"
---
...
![arm block init](/images/robot_arm/robot_arm/images/arm-block-init.png)
...
![arm block origin](/images/robot_arm/robot_arm/images/arm-block-origin.png)
...
![armbot theta](/images/robot_arm/robot_arm/images/armbot-theta.jpg)


    - Khối lệnh điều khiển servo khớp giữa tới một góc nào đó tức thời.
![arm block move base](/images/robot_arm/robot_arm/images/arm-block-move-base.png)
    ...
    Ví dụ:
![sample base](/images/robot_arm/robot_arm/images/sample-base.png)

    |
    
    
    - Khối lệnh điều khiển servo khớp giữa tới một góc tới hạn degree với thời gian nghỉ sleep sau mỗi bước di chuyển change.
![arm block rotate base](/images/robot_arm/robot_arm/images/arm-block-rotate-base.png)
    ...
    Ví dụ:
![sample base slow](/images/robot_arm/robot_arm/images/sample-base-slow.png)
...
![armbot radius](/images/robot_arm/robot_arm/images/armbot-radius.jpg)


    - Khối lệnh điều khiển servo khớp phải tới một góc nào đó tức thời.
![arm block move right](/images/robot_arm/robot_arm/images/arm-block-move-right.png)
    ...
    Ví dụ:
![sample right](/images/robot_arm/robot_arm/images/sample-right.png)

    |
    
    - Khối lệnh điều khiển servo khớp phải tới một góc tới hạn degree với thời gian nghỉ sleep sau mỗi bước di chuyển change.
![arm block rotate right](/images/robot_arm/robot_arm/images/arm-block-rotate-right.png)
    ...
    Ví dụ:
![sample right slow](/images/robot_arm/robot_arm/images/sample-right-slow.png)
...
![armbot height](/images/robot_arm/robot_arm/images/armbot-height.jpg)


    - Khối lệnh điều khiển servo khớp trái tới một góc nào đó tức thời.
![arm block move left](/images/robot_arm/robot_arm/images/arm-block-move-left.png)
    ...
    Ví dụ:
![sample left](/images/robot_arm/robot_arm/images/sample-left.png)

    |
    
    
    - Khối lệnh điều khiển servo khớp trái tới một góc tới hạn degree với thời gian nghỉ sleep sau mỗi bước di chuyển change.
![arm block rotate left](/images/robot_arm/robot_arm/images/arm-block-rotate-left.png)
    ...
    Ví dụ:
![sample left slow](/images/robot_arm/robot_arm/images/sample-left-slow.png)
...
![dau gap dong](/images/robot_arm/robot_arm/images/dau-gap-dong.png)

        |
    
    Góc mở của đầu gắp là 0 độ:
![dau gap mo](/images/robot_arm/robot_arm/images/dau-gap-mo.png)
    ...
    Ví dụ:
![sample dong mo dau gap](/images/robot_arm/robot_arm/images/sample-dong-mo-dau-gap.png)
...
![sample move a to b manual hd3](/images/robot_arm/robot_arm/images/sample-move-a-to-b-manual-hd3.png)
    ...
    |
![sample move a to b manual hd1](/images/robot_arm/robot_arm/images/sample-move-a-to-b-manual-hd1.png)
...
- Robot di chuyển tới lui: `Tại đây ](https://app.ohstem.vn/#!/share/yolobit/2DhFVaPf3jjVg6lRC7gj1d254DX)
![sample move a to b manual qr](/images/robot_arm/robot_arm/images/sample-move-a-to-b-manual-qr.png)
