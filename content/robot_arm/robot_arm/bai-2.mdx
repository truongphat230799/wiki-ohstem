---
title: "6. Lập trình di chuyển theo tọa độ ORZ"
---
...
![arm view 2 hd](/images/robot_arm/robot_arm/images/arm-view-2-hd.png)


**Góc nhìn từ trái qua phải:** Ta quan sát được 2 hướng chuyển động của đầu gắp là lên/xuống và tới/lui.
![arm view 1 hd](/images/robot_arm/robot_arm/images/arm-view-1-hd.png)


## Giới thiệu khối lệnh
![arm block kinematic](/images/robot_arm/robot_arm/images/arm-block-kinematic.png)
...
![arm get value 2](/images/robot_arm/robot_arm/images/arm-get-value-2.png)

    |
    
    2.  Kết nối ArmBot với máy tính qua cổng USB của Yolo:Bit
![arm get value 1](/images/robot_arm/robot_arm/images/arm-get-value-1.png)

    |
    
    3.  Vào App Controller của Yolo:Bit trên điện thoại, kết nối Bluetooth và điều khiển ArmBot tới các vị trí bạn mong muốn.
![arm get value 4](/images/robot_arm/robot_arm/images/arm-get-value-4.png)

    |
![arm get value 5](/images/robot_arm/robot_arm/images/arm-get-value-5.png)
...
![arm get value 3](/images/robot_arm/robot_arm/images/arm-get-value-3.png)
...
![sample move a to b orz s1](/images/robot_arm/robot_arm/images/sample-move-a-to-b-orz-s1.png)
...
![sample move a to b orz](/images/robot_arm/robot_arm/images/sample-move-a-to-b-orz.png)
...
- Robot di chuyển tới lui: `Tại đây ](https://app.ohstem.vn/#!/share/yolobit/2DhsDGYb0hAEEpgH9TbgTpH1KqH)
![sample move a to b orz qr](/images/robot_arm/robot_arm/images/sample-move-a-to-b-orz-qr.png)
