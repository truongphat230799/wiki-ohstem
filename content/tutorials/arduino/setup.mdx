---
title: "1. Hướng Dẫn Cài Đặt Arduino và xController"
---
...
![P1 1](/images/tutorials/arduino/images/P1-1.png)
...
![P1 2](/images/tutorials/arduino/images/P1-2.png)
...
![P1 3](/images/tutorials/arduino/images/P1-3.png)


  4. Vào menu `Tools > Board`, chọn loại board là `OhStem Boards > xController` vừa được cài đặt:
![P1 4](/images/tutorials/arduino/images/P1-4.png)
...
* :download:`Arduino Tutorial Code [https://github.com/AITT-VN/xbuild_creator_kit/tree/main/Arduino](https://github.com/AITT-VN/xbuild_creator_kit/tree/main/Arduino)`