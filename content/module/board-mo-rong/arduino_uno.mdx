...
- **Bước 1**: Chuẩn bị các thiết bị như sau:
   ...
   * - ![arduino uno4](/images/module/board-mo-rong/images/arduino_uno4.png)

     - ![arduino uno1](/images/module/board-mo-rong/images/arduino_uno1.png)
    
     - ![led don](/images/module/board-mo-rong/images/led_don.png)
    
     - ![nhan don](/images/module/board-mo-rong/images/nhan_don.png)
    
   * - Mạch Arduino UNO R3
     - Mạch mở rộng Arduino UNO
     - Đèn LED đơn (kèm dây Grove)
     - Nút nhấn đơn (kèm dây Grove)
   * - [Mua sản phẩm ](https://shop.ohstem.vn/san-pham/arduino-uno-r3/)
     - [Mua sản phẩm ](https://shop.ohstem.vn/san-pham/mach-mo-rong-cho-arduino/)
