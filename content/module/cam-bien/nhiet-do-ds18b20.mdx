---
title: "27. Cảm biến nhiệt độ DS18B20"
---

# 27. Cảm biến nhiệt độ DS18B20
![ds18b20](/images/module/cam-bien/images/ds18b20.png)
...
| <img src="/images/module/cam-bien/images/ds18b20.png" alt="ds18b20" width="180" /> | Cảm biến nhiệt độ DS18B20 | Mua tại các cửa hàng linh kiện điện tử |
    
- **Kết nối:**

    Chúng ta sẽ kết nối dây tương tự các cảm biến khác như DHT11, Module đèn led RGB hay quạt mini, cụ thể như hình:
![ds18b20 1](/images/module/cam-bien/images/ds18b20_1.png)
...
- Để làm việc với cảm biến nhiệt độ DS18B20, chúng ta phải cần thêm thư viện mở rộng **DS18B20**, bạn hãy copy đường dẫn sau: [https://github.com/AITT-VN/yolobit_extension_max30102](https://github.com/AITT-VN/yolobit_extension_max30102) và dán vào mục mở rộng để tải thư viện mở rộng.

    Xem hướng dẫn tải thư viện `tại đây ](https://docs.ohstem.vn/en/latest/module/thu-vien-yolobit.html)
![ds18b20 2](/images/module/cam-bien/images/ds18b20_2.png)
...
![ds18b20 3](/images/module/cam-bien/images/ds18b20_3.png)
