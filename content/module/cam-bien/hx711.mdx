---
title: "23. Mạch Chuyển Đổi ADC 24bit Loadcell HX711"
---

# 23. Mạch Chuyển Đổi ADC 24bit Loadcell HX711
![24.1](/images/module/cam-bien/images/24.1.png)
...
| <img src="/images/module/cam-bien/images/24.1.png" alt="24.1" width="180" /> | Module HX711(kèm dây Grove) | [Mua sản phẩm ](https://shop.ohstem.vn/san-pham/hx711/) |
| <img src="/images/module/cam-bien/images/24.2.jpg" alt="24.2" width="180" /> | Cảm biến cân nặng Loadcell (5kg) |  |
     -
...
![24.3](/images/module/cam-bien/images/24.3.png)
...
- **Bước 1**: Tải thư viện **HX711**, bằng cách dán đường link sau [https://github.com/AITT-VN/yolobit_extension_hx711.git](https://github.com/AITT-VN/yolobit_extension_hx711.git) vào phần tìm kiếm thư viện.

    Xem hướng dẫn tải thư viện `tại đây ](https://docs.ohstem.vn/en/latest/module/thu-vien-yolobit.html).
![hx711](/images/module/cam-bien/images/hx711.png)


    Sau khi tải thư viện thành công, trong danh mục khối lệnh sẽ xuất hiện các khối lệnh tương ứng:
![lenh hx711](/images/module/cam-bien/images/lenh_hx711.png)


    Để làm việc với module LED 7 đoạn bạn cần sử dụng câu lệnh sau để khai báo chân được sử dụng trong chương trình:
![24.4](/images/module/cam-bien/images/24.4.png)


- **Bước 2:** Chúng ta sẽ đặt tỷ lệ của cân tự động.
![24.5](/images/module/cam-bien/images/24.5.png)
...
![24.6](/images/module/cam-bien/images/24.6.png)
