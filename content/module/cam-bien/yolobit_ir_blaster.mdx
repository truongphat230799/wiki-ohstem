---
title: "33. Module IR Blaster (Hồng ngoại phát tín hiệu)"
---

# 33. Module IR Blaster (Hồng ngoại phát tín hiệu)
{/* Image not available: ir_01.png */}
...
- **Bước 1**: Chuẩn bị các thiết bị như sau:
   ...
   * - {/* Image not available: yolobit.png */}
...
```
   ...
   * - [Mua sản phẩm ](https://shop.ohstem.vn/san-pham/may-tinh-lap-trinh-yolobit/)
     ...
     - [Mua sản phẩm ](https://shop.ohstem.vn/san-pham/module-hong-ngoai-phat-ir/)
    
- **Bước 2**: Kết nối module IR Blaster vào **cổng digital bất kỳ** trên mạch mở rộng Grove:
{/* Image not available: ir_02.png */}
...
[https://github.com/AITT-VN/yolouno_extension_irblaster.git`
    ...
    Hướng dẫn chi tiết cài thư viện `tại đây ](https://docs.ohstem.vn/en/latest/module/thu-vien-yolobit.html)
{/* Image not available: ir_03.png */}


**Chương trình cơ bản để gửi tín hiệu hồng ngoại:**
{/* Image not available: ir_04.png */}
...
**Chương trình mẫu** [tại đây ](https://app.ohstem.vn/#!/share/yolouno/2irEXAMPLEsendTV)