---
title: "11. Cảm biến dò đường 2 mắt"
---

# 11. Cảm biến dò đường 2 mắt
![12.1](/images/module/cam-bien/images/12.1.png)
...
|:--------:|:---------|:--------:|
| <img src="/images/module/cam-bien/images/4in1.png" alt="4in1" width="180" /> | Xe robot 4in1 | [Mua sản phẩm ](https://shop.ohstem.vn/san-pham/xe-robot-4-in-1-do-choi-lap-trinh-robot/) |


## **4. Hướng dẫn lập trình:**
- **Bước 1:** Chọn thiết bị lập trình mà bạn có: BatmanBot, TankBot, TransformBot, Robot Wall - E trên OhStem App:
![12.2](/images/module/cam-bien/images/12.2.png)


- **Bước 2:** Gửi chương trình sau lên robot của bạn:
![12.3](/images/module/cam-bien/images/12.3.png)
