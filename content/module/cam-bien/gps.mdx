---
title: "24. Mạch định vị GPS BDS ATGM336H"
---

# 24. Mạch định vị GPS BDS ATGM336H
![gps01](/images/module/cam-bien/images/gps01.jpg)
...
| <img src="/images/module/cam-bien/images/gps01.jpg" alt="gps01" width="180" /> | Module GPS | [Mua sản phẩm ](https://shop.ohstem.vn/san-pham/module-gps/) |
    
    
- **Bước 2**: Cắm Yolo:Bit vào mạch mở rộng

- **Bước 3**: Kết nối dây tín hiệu với module và mạch mở rộng như hình:
![gps03](/images/module/cam-bien/images/gps03.jpg)
...
Để lập trình module GPS, chúng ta phải cần thêm thư viện mở rộng GPS, bạn hãy copy đường dẫn sau: [https://github.com/AITT-VN/yolobit_extension_gps.git](https://github.com/AITT-VN/yolobit_extension_gps.git) và dán vào mục mở rộng để tải thư viện mở rộng.

    Xem hướng dẫn tải thư viện `tại đây ](https://docs.ohstem.vn/en/latest/module/thu-vien-yolobit.html).
![gps](/images/module/cam-bien/images/gps.png)


**Chương trình cơ bản để lấy tín hiệu từ GPS:**

Đầu tiên chúng ta sẽ khởi tạo module GPS từ chân P10 và P13
![25.3](/images/module/cam-bien/images/25.3.png)


Sau khi khởi tạo, chúng ta sẽ cập nhật thông tin GPS bằng khối lệnh :
![25.4](/images/module/cam-bien/images/25.4.png)


Các thông tin chúng ta được GPS hỗ trợ sẽ bao gồm các thông tin như sau :
![25.5](/images/module/cam-bien/images/25.5.png)


Chương trình đơn giản để kiểm tra thời gian lấy được từ GPS khi ấn nút A sẽ như sau:
![25.6](/images/module/cam-bien/images/25.6.png)
...
![25.7](/images/module/cam-bien/images/25.7.png)
...
![25.8](/images/module/cam-bien/images/25.8.png)
...
![25.9](/images/module/cam-bien/images/25.9.png)
...
> **Ghi chú:** **Giải thích chương trình:** Sau khi chạy chương trình, thông tin vị trí sẽ được hiển thị trên cửa số Serial