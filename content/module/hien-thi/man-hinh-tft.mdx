...
![TFT ST7735](/images/module/hien-thi/images/TFT_ST7735.jpg)
...
| <img src="/images/module/hien-thi/images/TFT_ST7735.jpg" alt="TFT ST7735" width="180" /> | Màn hình TFT ST7735 | Mua ở các cửa hàng linh kiện điện tử |
...
- **Đối với màn hình TFT ST7735, chúng ta sẽ nối các cặp dây tương ứng như sau:**
    ...
    - CS = CS = P14
    - BL =VCC
![noi TFT ST7735](/images/module/hien-thi/images/noi_TFT_ST7735.jpg)


    Hướng dẫn nối dây màn hình TFT_ST7735
    
## 2.2 Màn hình TFT ILI9431
![TFT ILI9431](/images/module/hien-thi/images/TFT_ILI9431.jpg)
...
| <img src="/images/module/hien-thi/images/yolo.png" alt="yolo" width="180" /> | Máy tính lập trình Yolo:Bit | [Mua sản phẩm ](https://shop.ohstem.vn/san-pham/may-tinh-lap-trinh-yolobit/) |
| <img src="/images/module/hien-thi/images/mmr.png" alt="mmr" width="180" /> | Mạch mở rộng cho Yolo:Bit | [Mua sản phẩm ](https://shop.ohstem.vn/san-pham/grove-shield/) |
| <img src="/images/module/hien-thi/images/TFT_ILI9431.jpg" alt="TFT ILI9431" width="180" /> | Màn hình TFT ILI9431 | Mua ở các cửa hàng linh kiện điện tử |
...
## **3.1 Tải thư viện**
Để điều khiển được màn hình TFT LCD, chúng ta phải cần thêm thư viện mở rộng **TFT LCD**, bạn hãy copy đường dẫn sau: [https://github.com/AITT-VN/yolobit_extension_lcd_tft.git](https://github.com/AITT-VN/yolobit_extension_lcd_tft.git) và dán vào mục mở rộng để tải thư viện mở rộng.

    Xem hướng dẫn tải thư viện `tại đây ](https://docs.ohstem.vn/en/latest/module/thu-vien-yolobit.html).
![tft.1](/images/module/hien-thi/images/tft.1.png)

    |
    
    Sau khi tải thư viện, trong danh mục khối lệnh sẽ xuất hiện các khối lệnh tương ứng:
![tft.2](/images/module/hien-thi/images/tft.2.png)
...
![tft.3](/images/module/hien-thi/images/tft.3.png)
...
![tft.4](/images/module/hien-thi/images/tft.4.png)
