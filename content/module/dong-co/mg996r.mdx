---
title: "4. Động cơ Servo MG996R"
---

# 4. Động cơ Servo MG996R
![4.1](/images/module/dong-co/images/4.1.png)
...
| <img src="/images/module/dong-co/images/4.1.png" alt="4.1" width="180" /> | Động cơ Servo MG996R | [Mua sản phẩm ](https://shop.ohstem.vn/san-pham/dong-co-servo-mg996r/) |
| <img src="/images/module/dong-co/images/4.2.png" alt="4.2" width="180" /> | Pin 18650 | [Mua sản phẩm ](https://shop.ohstem.vn/san-pham/pin-sac-2s-8-4v-18650/) |
    
    
- **Bước 2**: Cắm Yolo:Bit vào mạch mở rộng
- **Bước 3**: Kết nối pin 18650 vào mạch mở rộng
- **Bước 4**: Kết nối servo vào **chân P4 trên mạch mở rộng**
![4.3](/images/module/dong-co/images/4.3.png)
...
![2.3](/images/module/dong-co/images/2.3.png)
...
![2.4](/images/module/dong-co/images/2.4.png)
...
- **Đối với động cơ servo 360 độ:**
    ...
    + Sử dụng khối lệnh sau trong danh mục **CHÂN CẮM**, để điều khiển:
![2.5](/images/module/dong-co/images/2.5.png)
    ...
    + Gửi chương trình sau xuống Yolo:Bit, để kiểm tra hoạt động của servo:
![2.6](/images/module/dong-co/images/2.6.png)
