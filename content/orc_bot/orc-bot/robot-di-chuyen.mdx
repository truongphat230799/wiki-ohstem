...
![5.3](/images/orc_bot/orc-bot/images/5.3.png)


## 1. **Giới thiệu khối lệnh**
Các khối lệnh để khai báo và điều khiển robot di chuyển nằm trong mục Di chuyển.
![5.4](/images/orc_bot/orc-bot/images/5.4.png)
![5.5](/images/orc_bot/orc-bot/images/5.5.png)
...
![5.6](/images/orc_bot/orc-bot/images/5.6.png)
...
![5.7](/images/orc_bot/orc-bot/images/5.7.png)
...
![5.8](/images/orc_bot/orc-bot/images/5.8.png)
...
![5.9](/images/orc_bot/orc-bot/images/5.9.png)
...
**Tham số:**
    ...
    - **then**: Cách robot dừng lại sau khi hoàn tất di chuyển, mặc định là STOP (tắt động cơ và để tự dừng lại theo quán tính) hoặc BRAKE (khóa động cơ để dừng ngay lập tức)
![5.10](/images/orc_bot/orc-bot/images/5.10.png)
...
![5.11](/images/orc_bot/orc-bot/images/5.11.png)
...
![5.12](/images/orc_bot/orc-bot/images/5.12.png)
...
> **Ghi chú:** - Khi chọn tốc độ quá thấp, lực quay của bánh xe không đủ mạnh để robot di chuyển,  robot sẽ đứng im tại chỗ. Để giải quyết vấn đề này, bạn chỉ cần chọn tốc độ cao hơn.
