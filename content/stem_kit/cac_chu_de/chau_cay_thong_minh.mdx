...
## 2. Hướng dẫn lắp ráp
- **Chuẩn bị**:
![chau cay thong minh](/images/stem_kit/cac_chu_de/images/chau_cay_thong_minh.png)
...
![chau cay thong minh 4](/images/stem_kit/cac_chu_de/images/chau_cay_thong_minh_4.png)


## 3. Hướng dẫn lập trình
1. Vào mục **Mở rộng** và tải thư viện **Sự kiện**:
![chau cay thong minh 2](/images/stem_kit/cac_chu_de/images/chau_cay_thong_minh_2.png)


2. Viết chương trình như sau:
![chau cay thong minh 3](/images/stem_kit/cac_chu_de/images/chau_cay_thong_minh_3.png)


**Link chương trình:** [https://app.ohstem.vn/#!/share/yolobit/2dtPSBZh4o8uJNol6yGziL6ltdL](https://app.ohstem.vn/#!/share/yolobit/2dtPSBZh4o8uJNol6yGziL6ltdL)

> **Ghi chú:** Chương trình sẽ thực hiện sự kiện kiểm tra độ ẩm của cây và ánh sáng môi trường sau mỗi 1 giây:
...
> **Lưu ý:**
> - Kiểm tra kết nối: cảm biến độ ẩm đất cổng **A**, đèn LED RGB cổng **B**, máy bơm mini cổng **M1** trước khi bật nguồn.
> - **Không để đầu cảm biến độ ẩm đất ngâm trong nước liên tục** — chỉ cắm vào đất để đo, điều này giúp tăng tuổi thọ cảm biến.
> - Ngưỡng độ ẩm (mặc định 40%) có thể điều chỉnh tùy loại cây và loại đất sử dụng.
> - Không để máy bơm hoạt động khi bình chứa nước đã cạn để tránh hư động cơ bơm.