...
![luon day](/images/stem_kit/cac_chu_de/images/luon_day.png)


        Vẽ ý tưởng ra giấy
    
    + Bước 2: Uốn cong dây kẽm theo hình vẽ và gắn lên hộp giấy
![luon day 2](/images/stem_kit/cac_chu_de/images/luon_day_2.png)
...
![luon day 3](/images/stem_kit/cac_chu_de/images/luon_day_3.png)

    |
    
## 3. Hướng dẫn lập trình
Viết chương trình như sau:
![luon day 4](/images/stem_kit/cac_chu_de/images/luon_day_4.png)


**Link chương trình:** [https://app.ohstem.vn/#!/share/yolobit/2dqZ9Kni40bNfFhGrWWlKSwfLzx](https://app.ohstem.vn/#!/share/yolobit/2dqZ9Kni40bNfFhGrWWlKSwfLzx)

> **Ghi chú:** Khi chương trình bắt đầu, chúng ta sẽ đổi trạng thái mặc định của chân P0 thành tắt. Trong quá trình chơi game, nếu 2 thanh kẽm chạm nhau, khi đó chân P0 sẽ bật tạo thành một mạch điện hoàn chỉnh, lúc này sẽ hiện hình ảnh SAD và phát bài nhạc DADADADUM để báo hiệu.

Sau khi 2 thanh kẽm chạm nhau, trò chơi kết thúc, lúc này chỉ cần nhấn nút A để bắt đầu lại trò chơi.

> **Lưu ý:**
> - Kết nối dây kẹp cá sấu chắc chắn vào chân **P0** và **P3** trên Yolo:Bit, đảm bảo tiếp xúc tốt để mạch điện hoạt động đúng.
> - Uốn thanh kẽm dài sao cho đường dẫn không quá thẳng (quá dễ) hoặc quá cong gấp khúc (quá khó) — điều chỉnh độ khó phù hợp với lứa tuổi học sinh.
> - Đầu móc câu của thanh kẽm ngắn cần được uốn tròn và nhẵn để không gây thương tích khi chạm tay.
> - Nếu mạch không phát hiện khi chạm, kiểm tra lại kết nối dây kẹp cá sấu và đảm bảo hai đầu kẽm dẫn điện tốt.