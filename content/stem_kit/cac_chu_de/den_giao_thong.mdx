...
## 2. Hướng dẫn lắp ráp
- **Chuẩn bị**:
![den giao thong](/images/stem_kit/cac_chu_de/images/den_giao_thong.png)
...
![den giao thong 3](/images/stem_kit/cac_chu_de/images/den_giao_thong_3.png)


## 3. Hướng dẫn lập trình
Viết chương trình như sau:
![den giao thong 2](/images/stem_kit/cac_chu_de/images/den_giao_thong_2.png)


**Link chương trình:** [https://app.ohstem.vn/#!/share/yolobit/2di2fCMnQc0ZWbJjoMXcCpPlgWc](https://app.ohstem.vn/#!/share/yolobit/2di2fCMnQc0ZWbJjoMXcCpPlgWc)

> **Ghi chú:** - Trong khối lệnh điều khiển đèn LED, bạn có thể chọn màu hiển thị.
...
> **Lưu ý:**
> - Kiểm tra kết nối dây của module đèn LED RGB vào đúng cổng **A** trước khi bật nguồn.
> - Không nhìn trực tiếp vào đèn LED khi đèn đang sáng để tránh ảnh hưởng đến mắt.
> - Thời gian đèn đỏ, vàng, xanh trong chương trình mẫu có thể điều chỉnh tùy ý cho phù hợp với thực tế.