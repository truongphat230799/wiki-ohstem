---
title: "7. Bật nảy khi nhân vật gặp tường"
---

# 7. Bật nảy khi nhân vật gặp tường
![4.1](/images/gamekit/gamekit/images/4.1.png)
...
Link chương trình mẫu: [Tại đây ](https://arcade.makecode.com/57094-19039-40123-56950)

**Bước 1**

Tìm `set mySprite to` trong `Sprite`. Kéo thả vào khối `on start`.
![4.2](/images/gamekit/gamekit/images/4.2.png)
...
![4.3](/images/gamekit/gamekit/images/4.3.png)
...
![4.4](/images/gamekit/gamekit/images/4.4.png)
...
![4.7](/images/gamekit/gamekit/images/4.7.png)
