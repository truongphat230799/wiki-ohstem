...
- Khối lệnh toán tử:
![bai 7.1](/images/robot_rover/rover/images/bai_7.1.png)
...
![bai 7.11](/images/robot_rover/rover/images/bai_7.11.png)


## Chương trình mẫu
- Bám sát mục tiêu: [Tại đây ](https://app.ohstem.vn/#!/share/yolobit/2BeVzmPaysgSHHG0dA9GriT347D)
![bai 7.12](/images/robot_rover/rover/images/bai_7.12.png)
