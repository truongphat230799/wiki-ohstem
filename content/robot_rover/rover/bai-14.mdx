...
Trên OhStem App đã tích hợp sẵn một GamePad ảo, bạn có thể sử dụng giao diện này để điều khiển Rover từ xa
    ...
    1.  Chọn Menu Gamepad
![bai 14.1](/images/robot_rover/rover/images/bai_14.1.png)



    2. Giao diện Gamepad ảo
![bai 14.2](/images/robot_rover/rover/images/bai_14.2.png)


## Giới thiệu khối lệnh
- Khối lệnh sử dụng Bluetooth:
![bai 14.3](/images/robot_rover/rover/images/bai_14.3.png)


- Khối lệnh đổi màu đèn LED:
![bai 14.4](/images/robot_rover/rover/images/bai_14.4.png)


## Viết chương trình
1. Viết thuật toán
![bai 14.5](/images/robot_rover/rover/images/bai_14.5.png)
