...
![bai 2.1](/images/robot_rover/rover/images/bai_2.1.png)



- Khối lệnh tạm dừng:
![bai 2.2](/images/robot_rover/rover/images/bai_2.2.png)


- Khối lệnh điều khiển động cơ:
![bai 2.3](/images/robot_rover/rover/images/bai_2.3.png)
...
Rover di chuyển nhờ sự hoạt động của 2 động cơ bên trái và phải. Vậy nếu 2 động cơ này đồng thời có chế độ hoạt động khác  nhau thì sẽ ra sao? Dưới đây là một số trường hợp di chuyển của 2 động cơ:
    ...
    - 2 động cơ quay cùng chiều, cùng tốc độ:
        ...
        - Nếu < 0: Lùi lại
        - Nếu = 0: Đứng yên
![bai 2.4](/images/robot_rover/rover/images/bai_2.4.png)
...
![bai 2.5](/images/robot_rover/rover/images/bai_2.5.png)



    - 2 động cơ quay khác chiều, cùng tốc độ: Xoay tại chỗ
![bai 2.6](/images/robot_rover/rover/images/bai_2.6.png)
...
![bai 2.7](/images/robot_rover/rover/images/bai_2.7.png)


2. Hiển thị hình ảnh mặt cười và dừng di chuyển trong 3 giây
![bai 2.8](/images/robot_rover/rover/images/bai_2.8.png)


## Chương trình mẫu
- Chú ý từng bước đi: [Tại đây ](https://app.ohstem.vn/#!/share/yolobit/2BeTZWPCx5nFzkliJbCzJplgYdw)
![bai 2.9](/images/robot_rover/rover/images/bai_2.9.png)
