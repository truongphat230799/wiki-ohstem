...
![bai 13.1](/images/robot_rover/rover/images/bai_13.1.png)


## Giới thiệu khối lệnh
- Khối lệnh remote:
![bai 13.2](/images/robot_rover/rover/images/bai_13.2.png)


- Khối lệnh xóa tín hiệu:
![bai 13.3](/images/robot_rover/rover/images/bai_13.3.png)


## Viết chương trình
1. Viết thuật toán
![bai 13.4](/images/robot_rover/rover/images/bai_13.4.png)


2. Tạo 4 điều kiện tương ứng với 4 nút di chuyển
![bai 13.5](/images/robot_rover/rover/images/bai_13.5.png)


3. Đặt lệnh di chuyển tương ứng với mỗi nút, dừng lại khi không nhận tín hiệu nào
![bai 13.6](/images/robot_rover/rover/images/bai_13.6.png)


4. Xóa tín hiệu để để tiếp tục chương trình
![bai 13.7](/images/robot_rover/rover/images/bai_13.7.png)


## Chương trình mẫu
- Hỗ trợ từ xa: [Tại đây ](https://app.ohstem.vn/#!/share/yolobit/2BeYIDNLNVND4XhPYZSvaoabYdV)
![bai 13.8](/images/robot_rover/rover/images/bai_13.8.png)
