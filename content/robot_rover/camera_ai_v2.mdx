...
## 1. Giới thiệu
![camera v2 1](/images/robot_rover/images/camera_v2_1.png)
...
![camera v2 2](/images/robot_rover/images/camera_v2_2.png)
...
![camera v2 3](/images/robot_rover/images/camera_v2_3.png)
...
![camera v2 4](/images/robot_rover/images/camera_v2_4.png)


3. Chọn tiếp vào **Configure WiFi**
![camera v2 5](/images/robot_rover/images/camera_v2_5.png)


Ở giao diện này bạn sẽ chọn mạng wifi mà mình muốn camera kết nối, **nhập mật khẩu wifi vào ô Password và chọn Save**:
![camera v2 6](/images/robot_rover/images/camera_v2_6.png)
...
![camera v2 7](/images/robot_rover/images/camera_v2_7.png)
...
![camera v2 8](/images/robot_rover/images/camera_v2_8.png)
...
![camera v2 9](/images/robot_rover/images/camera_v2_9.png)
...
![camera v2 10](/images/robot_rover/images/camera_v2_10.png)
...
![camera v2 11](/images/robot_rover/images/camera_v2_11.png)


5. Chọn **Export Model** để xuất ra mô hình:
![camera v2 12](/images/robot_rover/images/camera_v2_12.png)


6. Sau đó bạn ấn vào chọn **Upload my model**:
![camera v2 13](/images/robot_rover/images/camera_v2_13.png)


7. Một đường link sẽ xuất hiện, hãy **sao chép và dán vào đường dẫn AI trên trang địa chỉ của camera**:
![camera v2 14](/images/robot_rover/images/camera_v2_14.png)


Kết quả như hình:
![camera v2 15](/images/robot_rover/images/camera_v2_15.png)


## **4.3 Nhận dạng qua camera**
Sau khi đã điền xong các thông tin, bạn ấn **Bật camera** để bắt đầu nhận dạng:
![camera v2 16](/images/robot_rover/images/camera_v2_16.png)


Chờ khoảng 1 phút để hiện hình ảnh và kết quả nhận dạng sẽ được thể hiện trên màn hình, tương tự như hình sau:
![camera v2 17](/images/robot_rover/images/camera_v2_17.png)
...
1. Truy cập vào ](https://app.ohstem.vn/), chọn lập trình thiết bị **Yolo:Bit**.
![camera v2 18](/images/robot_rover/images/camera_v2_18.png)


2. Trong mục **Mở rộng**, tải thư viện **AI Camera**, để thiết bị đọc kết quả trực tiếp từ module camera AI:.

   **Link thư viện**: [https://github.com/AITT-VN/yolobit_extension_ai_camera.git](https://github.com/AITT-VN/yolobit_extension_ai_camera.git)
![camera v2 19](/images/robot_rover/images/camera_v2_19.png)


Các khối lệnh trong danh mục Camera AI:
![camera v2 20](/images/robot_rover/images/camera_v2_20.png)


3. Gửi chương trình cơ bản sau lên Robot Rover:
![camera v2 21](/images/robot_rover/images/camera_v2_21.png)


    ](https://app.ohstem.vn/#!/share/yolobit/2af4ex5ZvT1H6uh2rrWNMEFt4Ql)
...
![camera v2 22](/images/robot_rover/images/camera_v2_22.png)
...
![camera v2 23](/images/robot_rover/images/camera_v2_23.png)
...
![camera v2 24](/images/robot_rover/images/camera_v2_24.png)


**Kết quả nhận diện:**

Bật cùng lúc 2 tab địa chỉ IP của camera và bảng điều khiển IoT, kết quả được hiển thị tương tự như hình:
![camera v2 25](/images/robot_rover/images/camera_v2_25.png)
...
Mở tab mới, truy cập vào ](https://app.ohstem.vn/) chọn **lập trình thiết bị Yolo:Bit,** trong mục **Mở rộng** tìm kiếm và tải thư viện **MQTT**:
![camera v2 26](/images/robot_rover/images/camera_v2_26.png)


Cuối cùng, gửi chương trình sau vào Yolo:Bit:
![camera v2 27](/images/robot_rover/images/camera_v2_27.png)


    [https://app.ohstem.vn/#!/share/yolobit/2af4I5bvMQKIS5uUTxvzoy3ptf4](https://app.ohstem.vn/#!/share/yolobit/2af4I5bvMQKIS5uUTxvzoy3ptf4)
...
![camera v2 28](/images/robot_rover/images/camera_v2_28.png)


Tiếp theo, đăng ký nhận thông tin từ kênh dữ liệu (từ V1.. V20) để so sánh kết quả và thực hiện nhiệm vụ:
![camera v2 29](/images/robot_rover/images/camera_v2_29.png)
