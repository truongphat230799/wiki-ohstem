...
![gamepad](/images/robot_rover/images/gamepad.png)
...
![gamepad.1](/images/robot_rover/images/gamepad.1.png)


- **Thông số kỹ thuật của Gamepad:**
![gamepad.2](/images/robot_rover/images/gamepad.2.png)
...
![gamepad.3](/images/robot_rover/images/gamepad.3.png)


- **Mặt trên của Gamepad:**
![gamepad.4](/images/robot_rover/images/gamepad.4.png)
...
![gamepad.5](/images/robot_rover/images/gamepad.5.png)
...
![gamepad.6](/images/robot_rover/images/gamepad.6.png)
...
![gamepad.7](/images/robot_rover/images/gamepad.7.png)
...
## 7.1. **Thư viện**
1. Vào giao diện lập trình cho Yolo:Bit (hoặc xBot) trong OhStem App tại địa chỉ [https://app.ohstem.vn/](https://app.ohstem.vn/) hoặc ứng dụng OhStem App trên mobile ( Tải trên Google Play / App Store với tên tìm kiếm là “OhStem App”)
![thu vien.1](/images/robot_rover/images/thu_vien.1.png)


2. Nhấn vào mục Mở Rộng ở danh sách bên trái:
![thu vien.2](/images/robot_rover/images/thu_vien.2.png)


3. Chọn thư viện **Robocon** trong danh sách mục mở rộng có sẵn (hoặc nhập tên Robocon vào ô tìm kiếm nếu bạn không nhìn thấy):
![robocon](/images/robot_rover/images/robocon.png)


Chọn tải thư viện:
![thu vien.3](/images/robot_rover/images/thu_vien.3.png)
...
![robocon.2](/images/robot_rover/images/robocon.2.png)
...
![gamepad.8](/images/robot_rover/images/gamepad.8.png)
...
![gamepad.21](/images/robot_rover/images/gamepad.21.png)
...
![gamepad.22](/images/robot_rover/images/gamepad.22.png)
...
- **Robot Rover:**
    ...
    + **Lưu ý:** **Trước khi lập trình cho Gamepad, bạn cần tải thêm thư viện Rover cho Yolo:Bit**, xem hướng dẫn `tại đây ](https://docs.ohstem.vn/en/latest/robot_rover/rover/cai-dat-thu-vien.html).
    
    + **Chương trình mẫu** xem [tại đây ](https://app.ohstem.vn/#!/share/yolobit/2q3Oqi5PXIcrC679DAP6pXPgkPp).
![gamepad.23](/images/robot_rover/images/gamepad.23.png)
...
Bạn có thể tham khảo mạch động cơ của OhStem [tại đây ](https://docs.ohstem.vn/en/latest/module/dong-co/motor-drive.html).
...
> **Ghi chú:** Link thư viện tham khảo [https://github.com/AITT-VN/gamepad_receiver_arduino_lib.git](https://github.com/AITT-VN/gamepad_receiver_arduino_lib.git)