---
title: "4. Yolo UNO với nền tảng E-RA IoT-EoH"
---
...
- **Bước 1:** Truy cập vào link [https://app.e-ra.io/](https://app.e-ra.io/) trên web hoặc Truy cập CH Play/ App store, tìm kiếm ứng dụng **“E-Ra"** để cài đặt ứng dụng.
![era](/images/yolo_uno/yolo_uno_khoi_lenh/ai_iot/images/era.png)
...
![era 1](/images/yolo_uno/yolo_uno_khoi_lenh/ai_iot/images/era_1.png)
...
![era 2](/images/yolo_uno/yolo_uno_khoi_lenh/ai_iot/images/era_2.jpg)


- **Bước 3:** Truy cập vào giao diện làm việc với E-RA. Chọn vào gói dùng thử và chọn **Trải nghiệm ngay**:
![era 3](/images/yolo_uno/yolo_uno_khoi_lenh/ai_iot/images/era_3.png)


## 2.2 Tạo mới Unit (Địa điểm)
- **Bước 1:** Truy cập vào **Nhà phát triển** và chọn **Tạo địa điểm**
![era 4](/images/yolo_uno/yolo_uno_khoi_lenh/ai_iot/images/era_4.png)
...
![era 5](/images/yolo_uno/yolo_uno_khoi_lenh/ai_iot/images/era_5.png)
...
![era 6](/images/yolo_uno/yolo_uno_khoi_lenh/ai_iot/images/era_6.png)
...
![era 7](/images/yolo_uno/yolo_uno_khoi_lenh/ai_iot/images/era_7.png)
...
![era 8](/images/yolo_uno/yolo_uno_khoi_lenh/ai_iot/images/era_8.png)
...
![era 9](/images/yolo_uno/yolo_uno_khoi_lenh/ai_iot/images/era_9.png)
...
![era 10](/images/yolo_uno/yolo_uno_khoi_lenh/ai_iot/images/era_10.png)
...
![era 11](/images/yolo_uno/yolo_uno_khoi_lenh/ai_iot/images/era_11.png)


Gateway mới tạo có trên ứng dụng và có thể trải nghiệm giải pháp IOT của E-Ra. Gateway mới tạo sẽ hiện Trực tuyến (Online).
![era 12](/images/yolo_uno/yolo_uno_khoi_lenh/ai_iot/images/era_12.png)
...
![era 14](/images/yolo_uno/yolo_uno_khoi_lenh/ai_iot/images/era_14.png)


- **Bước 2:** Chọn thiết bị Input/Output mới.
![era 15](/images/yolo_uno/yolo_uno_khoi_lenh/ai_iot/images/era_15.png)


Tiếp theo **Đặt tên** và **Tạo** thiết bị:
![era 16](/images/yolo_uno/yolo_uno_khoi_lenh/ai_iot/images/era_16.png)


- **Bước 3:** Cấu hình chân ảo cho thiết bị

    + 1. Chọn thiết bị vừa tạo, truy cập vào mục Chân ảo và chọn **Tạo chân ảo**, như hình:
![era 17](/images/yolo_uno/yolo_uno_khoi_lenh/ai_iot/images/era_17.png)
...
![era 18](/images/yolo_uno/yolo_uno_khoi_lenh/ai_iot/images/era_18.png)
...
![era 19](/images/yolo_uno/yolo_uno_khoi_lenh/ai_iot/images/era_19.png)
...
![era 20](/images/yolo_uno/yolo_uno_khoi_lenh/ai_iot/images/era_20.png)


    Kết quả thực hiện 2 hành động như sau:
![era 21](/images/yolo_uno/yolo_uno_khoi_lenh/ai_iot/images/era_21.png)
...
![era 22](/images/yolo_uno/yolo_uno_khoi_lenh/ai_iot/images/era_22.png)


    2. Thêm một widget mới để điều khiển đèn LED
![era 23](/images/yolo_uno/yolo_uno_khoi_lenh/ai_iot/images/era_23.png)


    3. Đặt lại các cấu hình cho widget vừa tạo để điều khiển được đèn LED.
![era 24](/images/yolo_uno/yolo_uno_khoi_lenh/ai_iot/images/era_24.png)
...
![era 25](/images/yolo_uno/yolo_uno_khoi_lenh/ai_iot/images/era_25.png)


    + Chọn **Datastream**: Chọn Gateway & Device & DataStream nhấn chuột vào mũi tên chỉ xuống để chọn đúng các thông số sử dụng.
![era 26](/images/yolo_uno/yolo_uno_khoi_lenh/ai_iot/images/era_26.png)


    + Chọn **hành động (Action)** cho widget: Điều chỉnh trạng thái của nút nhấn
![era 27](/images/yolo_uno/yolo_uno_khoi_lenh/ai_iot/images/era_27.png)
...
![era 28](/images/yolo_uno/yolo_uno_khoi_lenh/ai_iot/images/era_28.png)
...
Chương trình mẫu: Xem `tại đây ](https://app.ohstem.vn/#!/share/yolouno/2cz6bbVk5sYZZn50BL0dajNNgEJ)
...
![era 29](/images/yolo_uno/yolo_uno_khoi_lenh/ai_iot/images/era_29.png)


Chọn tiếp vào Pin Input/Output. Tạo một thiết bị Pin mới và đặt tên là **Nhiệt độ**,tương tự điều khiển LED.
![era 30](/images/yolo_uno/yolo_uno_khoi_lenh/ai_iot/images/era_30.png)


Cấu hình Chân ảo cho Nhiệt độ là V2
![era 31](/images/yolo_uno/yolo_uno_khoi_lenh/ai_iot/images/era_31.png)
...
![era 32](/images/yolo_uno/yolo_uno_khoi_lenh/ai_iot/images/era_32.png)


Tiếp tục cấu hình widget cho nhiệt độ:
![era 33](/images/yolo_uno/yolo_uno_khoi_lenh/ai_iot/images/era_33.png)
...
![era 34](/images/yolo_uno/yolo_uno_khoi_lenh/ai_iot/images/era_34.png)


Chương trình mẫu: Xem [tại đây ](https://app.ohstem.vn/#!/share/yolouno/2cz6kYsMJpeOwVdghKY9JoYHDt4)

Gửi chương trình lên Yolo UNO và mở bảng điều khiển để quan sát kết quả:
![era 35](/images/yolo_uno/yolo_uno_khoi_lenh/ai_iot/images/era_35.png)
