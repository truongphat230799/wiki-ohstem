---
title: "19. Module truyền nhận không dây LoRa E32 (SX1278)"
---

# 19. Module truyền nhận không dây LoRa E32 (SX1278)
![lorae32 01](/images/yolo_uno/yolo_uno_khoi_lenh/cam_bien/images/lorae32_01.png)
...
|:--------:|:---------|:--------:|
| <img src="/images/yolo_uno/yolo_uno_khoi_lenh/cam_bien/images/yolo_uno.png" alt="yolo uno" width="180" /> | Yolo UNO | [Mua sản phẩm ](https://shop.ohstem.vn/san-pham/yolo-uno/) |
| <img src="/images/yolo_uno/yolo_uno_khoi_lenh/cam_bien/images/lorae32_01.png" alt="lorae32 01" width="180" /> | Module LoRa E32 | [Mua sản phẩm ](https://shop.ohstem.vn/san-pham/lora-e32/) |
...
- **Bước 2**: Kết nối module LoRa E32 vào cổng **UART** của mạch mở rộng, ví dụ này sẽ nối vào chân D3-D4:
  ...
  + VCC → 3.3V
  + GND → GND
![lorae32 02](/images/yolo_uno/yolo_uno_khoi_lenh/cam_bien/images/lorae32_02.png)
...
![lorae32 03](/images/yolo_uno/yolo_uno_khoi_lenh/cam_bien/images/lorae32_03.png)


Sau khi tải xong, khối lệnh **LoRa E32** sẽ xuất hiện trong danh mục khối mở rộng.
Các khối chính bao gồm:
![lorae32 03 1](/images/yolo_uno/yolo_uno_khoi_lenh/cam_bien/images/lorae32_03-1.png)
...
![lorae32 04](/images/yolo_uno/yolo_uno_khoi_lenh/cam_bien/images/lorae32_04.png)
...
**Thiết bị gửi:**
![lorae32 05](/images/yolo_uno/yolo_uno_khoi_lenh/cam_bien/images/lorae32_05.png)


**Thiết bị nhận:**
![lorae32 06](/images/yolo_uno/yolo_uno_khoi_lenh/cam_bien/images/lorae32_06.png)
...
![lorae32 07](/images/yolo_uno/yolo_uno_khoi_lenh/cam_bien/images/lorae32_07.png)
