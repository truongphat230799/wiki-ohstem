...
![thung rac](/images/yolo_uno/arduino_yolo_uno/images/thung_rac.png)


## 3. Chương trình Arduino
Bạn cần cài đặt thư viện **HCSR04** và **SoftServo**:
![thung rac 2](/images/yolo_uno/arduino_yolo_uno/images/thung_rac_2.png)
