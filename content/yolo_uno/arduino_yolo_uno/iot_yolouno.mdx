...
![iot01](/images/yolo_uno/arduino_yolo_uno/images/iot01.png)


## 2. Kết nối
Đèn led đơn được nối với chân D13 trên mạch Yolo UNO và được tích hợp sẵn trên mạch.
![iot02](/images/yolo_uno/arduino_yolo_uno/images/iot02.png)


## 3. Chương trình Arduino
Bạn cần cài đặt thêm thư viện **PubSubClient** cho Arduino.
![iot03](/images/yolo_uno/arduino_yolo_uno/images/iot03.png)
