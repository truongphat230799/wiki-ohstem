---
title: "1. Hướng Dẫn Cài Đặt Arduino và Yolo UNO"
---

# 1. Hướng Dẫn Cài Đặt Arduino và Yolo UNO

- **Bước 1**: Vào trang chủ của Arduino để download **Arduino IDE** theo link này [https://www.arduino.cc/en/software/](https://www.arduino.cc/en/software/). Trong mục Download options như hình dưới, bạn chọn **Win 10 and newer** để download.
![cai dat 1](/images/yolo_uno/arduino_yolo_uno/images/cai_dat_1.png)
...
![cai dat 2](/images/yolo_uno/arduino_yolo_uno/images/cai_dat_2.png)
...
![cai dat 3](/images/yolo_uno/arduino_yolo_uno/images/cai_dat_3.png)
...
![cai dat 4](/images/yolo_uno/arduino_yolo_uno/images/cai_dat_4.png)


Sau khi cài đặt, kết nối mạch Yolo UNO với máy tính qua dây cáp USB, chọn mạch Yolo UNO và kết nối.
![cai dat 5](/images/yolo_uno/arduino_yolo_uno/images/cai_dat_5.png)
