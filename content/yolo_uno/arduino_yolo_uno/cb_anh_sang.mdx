...
![cb anh sang](/images/yolo_uno/arduino_yolo_uno/images/cb_anh_sang.png)


## 2. Kết nối
Kết nối cảm biến ánh sáng vào cổng A0 của Yolo UNO.
![cb anh sang 2](/images/yolo_uno/arduino_yolo_uno/images/cb_anh_sang_2.png)
...
![cb anh sang 3](/images/yolo_uno/arduino_yolo_uno/images/cb_anh_sang_3.png)


Sau khi upload, bạn quan sát giá trị cường độ ánh sáng được in ra cửa sổ Serial và sự thay đổi khi bạn che cảm biến lại.
![cb anh sang 4](/images/yolo_uno/arduino_yolo_uno/images/cb_anh_sang_4.png)
