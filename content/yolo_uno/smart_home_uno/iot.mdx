---
title: "7. Nhận và gửi thông tin lên server IoT"
---
...
![iot 1](/images/yolo_uno/smart_home_uno/images/iot_1.png)
...
![iot 2](/images/yolo_uno/smart_home_uno/images/iot_2.png)
...
![iot 3](/images/yolo_uno/smart_home_uno/images/iot_3.png)


Kết quả như sau:
![iot 4](/images/yolo_uno/smart_home_uno/images/iot_4.png)
![iot 16](/images/yolo_uno/smart_home_uno/images/iot_16.png)
...
![iot 5](/images/yolo_uno/smart_home_uno/images/iot_5.png)


2. Vào mục **Nâng cao**, chọn danh mục khối lệnh **IoT**:
![iot 6](/images/yolo_uno/smart_home_uno/images/iot_6.png)
...
![iot 7](/images/yolo_uno/smart_home_uno/images/iot_7.png)


- Câu lệnh gửi kết quả từ thiết bị lên bảng điều khiển
![iot 8](/images/yolo_uno/smart_home_uno/images/iot_8.png)


- Câu lệnh nhận thông tin từ kênh dữ liệu của server để điều khiển thiết bị hoạt động.
![iot 9](/images/yolo_uno/smart_home_uno/images/iot_9.png)


- Câu lệnh dùng để so sánh kết quả thông tin thiết bị nhận được từ server.
![iot 10](/images/yolo_uno/smart_home_uno/images/iot_10.png)


## **5.2 Viết chương trình**
Thực hiện các thao tác sau để mở chương trình **Nhận và gửi thông tin lên server**:
![iot 11](/images/yolo_uno/smart_home_uno/images/iot_11.png)


    [https://app.ohstem.vn/#!/share/yolouno/2vFe6PGbnqNlVl1g0bLUgPK1QiC](https://app.ohstem.vn/#!/share/yolouno/2vFe6PGbnqNlVl1g0bLUgPK1QiC)
...
![iot 13](/images/yolo_uno/smart_home_uno/images/iot_13.png)
...
![iot 14](/images/yolo_uno/smart_home_uno/images/iot_14.png)
...
![iot 15](/images/yolo_uno/smart_home_uno/images/iot_15.png)


- **Bước 4**:  Điều khiển quạt trên board từ bảng điều khiển IoT:
![iot 17](/images/yolo_uno/smart_home_uno/images/iot_17.png)
